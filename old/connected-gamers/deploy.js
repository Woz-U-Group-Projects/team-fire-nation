...
function installPM2() {
  ...
  function createRemoteTempFolder() {
    return ssh.execCommand(
      'rm -rf connected-gamers-temp && mkdir connected-gamers-temp', {
        cwd: '/home/ubuntu'
    });
  }
  ...
  function updateRemoteApp() {
    return ssh.execCommand(
      'cp -r connected-gamers-temp/* connected-gamers/ && rm -rf connected-gamers-temp', {
        cwd: '/home/ubuntu'
    });
  }
  ...
  function restartRemoteServices() {
    return ssh.execCommand(
      'cd connected-gamers && sudo service mongod start && pm2 start app.js', {
        cwd: '/home/ubuntu'
    });
  }
